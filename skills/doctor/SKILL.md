---
name: sc4sap:doctor
description: Diagnose SC4SAP plugin health, MCP server connectivity, and SAP system connection
level: 2
---
...
<Purpose>
sc4sap:doctor runs a structured health check across three layers: the SC4SAP plugin itself, the mcp-abap-adt MCP server registration, and the live SAP system connection. It surfaces problems with clear remediation steps so you can get back to development quickly.
</Purpose>
